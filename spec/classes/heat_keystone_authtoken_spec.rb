  ...
  shared_examples 'heat authtoken' do
    ...
    context 'with default parameters' do
      ...
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_heat_config('keystone_authtoken/service_token_roles').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_heat_config('keystone_authtoken/service_token_roles_required').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_heat_config('keystone_authtoken/service_type').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_heat_config('keystone_authtoken/interface').with_value('<SERVICE DEFAULT>')
      end
    end
    ...
    context 'when overriding parameters' do
      ...
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_heat_config('keystone_authtoken/service_token_roles').with_value(params[:service_token_roles])
        is_expected.to contain_heat_config('keystone_authtoken/service_token_roles_required').with_value(params[:service_token_roles_required])
        is_expected.to contain_heat_config('keystone_authtoken/service_type').with_value(params[:service_type])
        is_expected.to contain_heat_config('keystone_authtoken/interface').with_value(params[:interface])
      end
    ...
    context 'when overriding parameters via params hash' do
      ...
      it 'configure keystone_authtoken' do
        is_expected.to contain_heat_config('keystone_authtoken/username').with_value(params[:params]['username'])
      end
    end
  end
